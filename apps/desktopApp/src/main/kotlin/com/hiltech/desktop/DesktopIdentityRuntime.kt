...
class DesktopIdentityRuntime(
    ...
    suspend fun createWorkOrder(
        ...
        workTypeCode:String,workTypeRevision:Int,title:String,description:String?,priorityCode:String?,
        baseProjectVersion:Long,baselineVersion:Int,
    ) = workApi.create(projectId,CreateWorkOrderRequestDto(operationId(),siteId,projectSiteId,areaId,workPackageId,null,workTypeCode,workTypeRevision,title,description,null,null,priorityCode,baseProjectVersion,baselineVersion,occurredAt()),installationId)

    suspend fun updateWorkOrder(workOrderId:String,areaId:String?,workPackageId:String?,title:String,description:String?,priorityCode:String,baseVersion:Long)=
        workApi.update(workOrderId,UpdateWorkOrderRequestDto(operationId(),areaId,workPackageId,title,description,null,null,priorityCode,baseVersion,occurredAt()),installationId)
