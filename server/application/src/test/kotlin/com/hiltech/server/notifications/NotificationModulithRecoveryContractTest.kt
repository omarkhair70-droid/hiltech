...
class NotificationModulithRecoveryContractTest {
    private val enabled =
        System.getenv(
    ...
    @Test
    fun failedProductionNotificationProjectionIsDurableRecoverableAndDeduplicated() {
        assumeTrue(enabled)
        ...
        val context =
            SpringApplicationBuilder(
                NotificationRecoveryTestApplication::class.java,
            )
                .web(
        ...
        try {
            ...
            val event =
                ApprovalRequested(
                    ...
                    occurredAt =
                        Instant.parse(
                            "2026-09-20T00:55:00.123456789Z",
                        ),
                    correlationId =
                        "corr-notification-recovery",
                )
            ...
            await(
                "failed production Notification publication",
            ) {
                publicationStatus(
                    jdbc = jdbc,
                    eventId =
            ...
            await(
                "recovered production Notification projection",
            ) {
                publicationStatus(
                    jdbc = jdbc,
                    eventId =
            ...
            assertEquals(
                ...
                "Completed publication resubmission must not duplicate the Notification intent.",
            )
    ...
    private fun notificationVersion(
        jdbc: JdbcTemplate,
        requestId: UUID,
    ): Long =
        requireNotNull(
...
@Import(
    ...
    JdbcNotificationPersistence::class,
    ApprovalNotificationProjectionListener::class,
)
class NotificationRecoveryTestApplication
